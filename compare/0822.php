...
<body>
    ...
    <script>
        ...
        selectedRestaurants.forEach((id, index) => {
            ...
            const rgbaBackgroundColor = hexToRgba(backgroundColor, 0.5); // 将 hex 颜色转换为 rgba 格式，并设置透明度为 0.5
            ...
            if (restaurantData) {
                ...
                const parkingSvg = `<svg fill="${restaurantData.r_has_parking == 1 ? '#0000FF' : '#A9A9A9'}" width="20px" height="20px" viewBox="0 0 454 454" xmlns="http://www.w3.org/2000/svg"><g><g><path d="M228.062,154.507h-34.938v65.631h34.938c18.094,0,32.814-14.72,32.814-32.814C260.877,169.23,246.156,154.507,228.062,154.507z"/><path d="M0,0v454h454V0H0z M228.062,279.648h-34.938v79.398h-59.512V94.952l94.451,0.043c50.908,0,92.325,41.418,92.325,92.328C320.388,238.232,278.971,279.648,228.062,279.648z"/></g></g></svg>`;
                ...
                parkingButton.addEventListener('click', function() {
                    ...
                    console.log('Parking selected:', selectedItems.parking);
                });
                ...
                priceButton.addEventListener('click', function() {
                    ...
                    console.log('Price range for restaurant', id, ':', selectedItems.price[id]);
                });
                ...
                diningTimeButton.addEventListener('click', function() {
                    ...
                    console.log('Dining time for restaurant', id, ':', selectedItems.diningTime[id]);
                });
                ...
                if (restaurantData.r_vibe) {
                    ...
                    vibes.forEach(vibe => {
                        ...
                        button.addEventListener('click', function() {
                            ...
                            button.style.backgroundColor = selectedItems.vibe[vibe] ? '#F4DEB3' : '';
                            console.log('Vibe selected:', vibe, selectedItems.vibe[vibe]);
                        });
                ...
                if (restaurantData.r_food_dishes) {
                    ...
                    dishes.forEach(dish => {
                        ...
                        button.addEventListener('click', function() {
                            ...
                            button.style.backgroundColor = selectedItems.food[dish] ? '#F4DEB3' : '';
                            console.log('Food dish selected:', dish, selectedItems.food[dish]);
                        });
                ...
                const imageToggleButtons = ['環境', '食物', '菜單', '地圖'].map(category => {
                    ...
                    button.addEventListener('click', function() {
                        ...
                        console.log('Image category selected:', category);
                    });
